"""
🎨 RepletO v2.0 - Backend Simplificado CORREGIDO
==============================================

Versión funcional sin APIs deprecadas
"""
...
async def root():
    ...
    <body>
        <div class="version">v2.0.0 FIXED</div>
        <div class="container">
            <div class="logo">🎨</div>
...
if os.path.exists(frontend_path):
    ...
    logger.info(f"✅ Frontend montado en /frontend/")
...
if __name__ == "__main__":
    ...
    logger.info("🎨 RepletO v2.0 FIXED - Iniciando servidor de desarrollo...")
    
    uvicorn.run(
        "main_simple_fixed:app",  # Usar este archivo
        host="0.0.0.0",
        port=8000,
        reload=True,
        log_level="info"
